...
public class RegistrarTest {
    ...
    public void testpromoteAllStudents() {
        ...
        try {
            ...
            System.out.println("Caught GPATooLowException, should not have");
            e.printStackTrace();
        } catch (NoCoursesTakenException e) {
            System.out.println("Caught NoCoursesTakenException, should not have");
            e.printStackTrace();
        }
    ...
    public void testregisterStudent() {
        ...
        try {
            ...
            System.out.println("Caught CourseFullException, should not have");
            e.printStackTrace();
        } catch (MissingPrereqException e) {
            System.out.println("Caught MissingPrereqException, should not have");
            e.printStackTrace();
        }
